...
<LecturerLoginScreen>:                  
    ...
    MDFloatLayout:
        ...
        MDButton:
            ...
            on_release:
                root.manager.transition.direction = "left"
                root.manager.current = "lecturerInfo"
...
class LecturerInfoScreen(Screen):
    pass
...
class ClassCheckInApp(MDApp):
    ...
    def build(self):
        ...
        screen_manager.add_widget(LecturerInfoScreen(name="LecturerInfo"))
